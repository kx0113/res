...
<div class="system-messageq" style="background: #fff">
	<!--p style="height:35px;background:<?php if($message !== '' ){ echo 'url(/res/Public/img/msg_top_bg_new.png)'; }else{ echo 'url(/res/Public/img/msg_top_bg.png)'; } ?> #ccc;padding-left:10px;line-height:35px;color:white">提醒</p-->
	...
	<div style="padding:24px;">
		<?php if(isset($message)): ?><div class="alert alert-block alert-success" style="border-radius:5px;" >
			...
			<div class="alert alert-danger " style="border-radius:5px;" >
				<div style="margin:0 0 15px 0 ;padding:0 0 10px 0;font-size:16px;border-bottom: 1px solid #e6c1c7">错误提示</div>
