                    ...
                    <form class="form-horizontal" role="form"  id="form1" enctype="multipart/form-data" action="" method="get">
                        <div style="margin:7px 0 0  0;">
                            <div  class=" margin0 fl  margin01500">
                                <a  href="<?php echo U(CONTROLLER_NAME . '/add',array('par'=>$par));?>" class="btn btn-danger fl margin01500">添加</a>
                            ...
                            <a style="" href="javascript:$('form').submit()" class="btn btn-primary ">查询</a>
                        </div>
                        <div class="clb"></div>
                    </form><br>
                    <!-- Example Cellstyle -->
                        ...
                        <div class="example">
                            <table data-toggle="table" data-url="" data-mobile-responsive="true">
                                ...
                                <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                        ...
                                        <?php if($par == '82121'): ?><td><?php echo (getGoodsClassName($vo["value"])); ?></td><?php endif; ?>
                                        <td><?php echo ($vo["name"]); ?></td>
                                        <td class="hidden-480"><?php echo ($vo["value"]); ?></td>
                                        <td class="hidden-480"><?php echo ($vo["sort"]); ?></td>
                                        <td class="hidden-480"> <?php echo (date("Y-m-d  H:i:s",$vo["time"])); ?> </td>
                                        <td>
                                            <a href="<?php echo u(CONTROLLER_NAME . '/EditData',array('id'=>$vo['id'],'par'=>$par));?>" >[编辑] </a>
