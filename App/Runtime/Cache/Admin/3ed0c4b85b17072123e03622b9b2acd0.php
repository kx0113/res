                ...
                <div class="ibox-content">
                    ...
                    <form class="form-horizontal m-t"  method='post'  action="" name="form" id="commentForm" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-5">
                                <input id="packagename" name="packagename" class="form-control" type="text"  required aria-required="true" >
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-3 control-label">路径：</label>
                            <div class="col-sm-5">
                                <input id="funcname" name="funcname" class="form-control" type="text" required aria-required="true" >
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <label class="radio-inline">
                                    <input type="radio" checked="" value="1" id="ipt" name="ipt">功能</label>
                                <label class="radio-inline">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <label class="radio-inline">
                                    <input type="radio" checked="" value="1" id="status" name="status" checked>启用</label>
                                <label class="radio-inline">
                                    <input type="radio" value="0" id="status" name="status">关闭</label>
                            </div>
                        </div>
